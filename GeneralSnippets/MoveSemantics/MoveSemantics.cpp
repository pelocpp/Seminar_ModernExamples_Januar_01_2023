...
namespace MoveSemantics {
    ...
    public:
        ...
        // Rule of Five // Big - Five
        // move semantics
        BigData(BigData&&) noexcept;  // move c'tor // PERFORMANZ
    ...
    BigData::BigData(BigData&& data) noexcept {  // move c'tor
        ...
        m_size = data.m_size;
        data.m_data = 0;  // reset source object, ownership has been moved
        data.m_size = 0;
    }
    ...
    void test_02_demonstrate_move_ctor() {
        ...
        // a) ein temp. Objekt:  BigData{ 10, 1 }
        // b) Automatisch erzeugt: Aufruf des Destruktors dieses temp. Objekt
        // C) Bei Move-Semantik (Muss): Der fragliche Zeiger wurde ja verschoben
        //    kopiert, DESHALB muss der originale Zeiger auf 0 gesetzt werden.
        //            data.m_data = 0; // NULL // nullptr 

        // i)  C / free:       free (0)     ABSTURZ !!!!
        // ii) C++ / delete:   delete (0)   KEIN ABSTURZ !!!!
